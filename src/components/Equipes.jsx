...
function Equipes() {
  return (
    ...
    id='Notre travail' className='flex flex-col items-center gap-7
     px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
      
      <Title  Title='Rencontrer notre équipe' desc='Un passionant équipe expert de digital
       dedié  spécifiquement à votre succès'/>
